...
def update_button_function():
    ...
    try:
        ...
        error('Failed to extract the downloaded "' + mod_name + '.zip" file:', sys.exc_info())
    ...
    try:
        ...
        error('Failed to write the new version to the "options.ini" file:', sys.exc_info())
...
if __name__ == '__main__':
    ...
    try:
        ...
        warning('Failed to check GitHub for the latest version:', sys.exc_info())
